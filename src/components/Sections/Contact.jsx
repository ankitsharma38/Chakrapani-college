    ...
    <section className="py-20 px-8 bg-green-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          {/* Right Box: Contact Details & Form */}
          <motion.div 
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5 }}
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <input type="text" className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-green-400" placeholder="Your Name" />
              </div>
              <div>
                <label className="text-gray-700 font-medium">Email</label>
                <input type="email" className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-green-400" placeholder="Your Email" />
              </div>
              <div>
                <label className="text-gray-700 font-medium">Message</label>
                <textarea className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-green-400" rows="4" placeholder="Your Message"></textarea>
              </div>
